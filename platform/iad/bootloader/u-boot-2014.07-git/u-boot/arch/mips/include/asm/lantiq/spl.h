...
#if defined(CONFIG_LTQ_SUPPORT_SPL_NAND_FLASH) && defined(CONFIG_SYS_BOOT_UBISPL)
#define spl_boot_ubi		1
#endif

#if !defined(spl_boot_spi_flash)
#define spl_boot_spi_flash	0
#endif

#if !defined(spl_boot_nor_flash)
#define spl_boot_nor_flash	0
#endif

#if !defined(spl_boot_nand_flash)
#define spl_boot_nand_flash	0
#endif

#if !defined(spl_boot_hsnand_flash)
#define spl_boot_hsnand_flash	0
#endif

#if !defined(spl_boot_ubi)
#define spl_boot_ubi	0
#endif

#if !defined(spl_init_lowlevel)
#define spl_init_lowlevel	0
#endif
