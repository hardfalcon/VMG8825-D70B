...
{
	if (nand_cs1)
		ltq_setbits(&ltq_nand_regs->con, NAND_CON_OUT_CS1 | NAND_CON_IN_CS1);
	else
		ltq_clrbits(&ltq_nand_regs->con, NAND_CON_OUT_CS1 | NAND_CON_IN_CS1);
...
void nand_init(void)
{
	if (nand_cs1)
		ltq_writel(&ltq_nand_regs->con, NAND_CON_LATCH_ALL |
				   NAND_CON_OUT_CS1 | NAND_CON_IN_CS1 | NAND_CON_PRE_P | NAND_CON_WP_P |
				   NAND_CON_SE_P | NAND_CON_CS_P | NAND_CON_CSMUX | NAND_CON_NANDM);
	else
		ltq_writel(&ltq_nand_regs->con, NAND_CON_LATCH_ALL |
