...
/*!
 * \fn u32 ltq_dma_chan_get_desc_vir_base(u32 chan)
 * \brief Get descriptor base virtual address
 * \param[in] chan   DMA logical channel number
 * \return channel descriptor base virtual address
 *
 * This function returns the descriptor base virtual address to
 * the caller.
 * In normal case, callers should not care about it. It provides a chance
 * to caller to manipulate the DMA related stuff by itself
 */
extern u32 ltq_dma_chan_get_desc_vir_base(u32 chan);
