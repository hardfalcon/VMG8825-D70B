...
#if defined(CONFIG_LANTIQ_VRX318) || defined(CONFIG_LANTIQ_VRX318_MODULE) || \
	defined(CONFIG_VRX518) || defined(CONFIG_VRX518_MODULE)
...
static inline int ifx_pcie_ep_dev_num_get(int *dev_num)
{
	return -EIO;
}

static inline int ifx_pcie_ep_dev_info_req(int dev_idx, ifx_pcie_ep_int_module_t module,
				ifx_pcie_ep_dev_t *dev)
{
	return -EIO;
}

static inline int ifx_pcie_ep_dev_info_release(int dev_idx)
{
	return -EIO;
}
