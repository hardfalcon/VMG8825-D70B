...
extern const char *ifx_eth_fw_netdev_physname(struct net_device *dev);
extern const char *ifx_eth_fw_netdev_realname(struct net_device *dev);
extern struct net_device *ifx_eth_fw_find_by_physname(const char *name);
