...
#define PMU_GPHY3	BIT(26) /* xrx330 */
#define PMU_USB1	BIT(27)
#define PMU_SWITCH	BIT(28)
#define PMU_PPE_TOP	BIT(29)
#define PMU_GPHY0	BIT(29) /* xrx330 */
#define PMU_GPHY	BIT(30)
#define PMU_GPHY1	BIT(30) /* xrx330 */
#define PMU_PCIE_CLK	BIT(31)
#define PMU_GPHY2	BIT(31) /* xrx330 */
...
EXPORT_SYMBOL_GPL(ltq_dmanand_membase);
...
void __init ltq_soc_init(void)
{
	...
	if (of_machine_is_compatible("lantiq,grx390") ||
		...
		clkdev_add_pmu("1f203018.rcu-usb", "phy", 1, 2,
			PMU_ANALOG_USB0_P);
		clkdev_add_pmu("1f203034.rcu-usb", "phy", 1, 2,
			PMU_ANALOG_USB1_P);

		clkdev_add_pmu("1f203020.gphy", NULL, 1, 0, PMU_GPHY0);
		clkdev_add_pmu("1f203058.gphy", NULL, 1, 0, PMU_GPHY1);
	...
	if (of_machine_is_compatible("lantiq,ase")) {
		...
		clkdev_add_pmu("1f203018.rcu-usb", "phy", 1, 0, PMU_USB0_P);
		clkdev_add_pmu("1e101000.usb", "otg", 1, 0,
			PMU_USB0);
		clkdev_add_pmu("1f203034.rcu-usb", "phy", 1, 0, PMU_USB1_P);
		clkdev_add_pmu("1e106000.usb", "otg", 1, 0,
			PMU_USB1);
