...
static void cport_sgmii_config(void *cdev)
{
	...
	gsw_w32(cdev, 0xD304, 0, 16, 0x80b8);
	/*SGMII_PHY SGMII PHY mode */
	gsw_w32(cdev, 0xD304, 0, 16, 0x80b0);

	/*Foced the SGMII @2.5G/FD mode*/
	gsw_w32(cdev, 0xD30A, 0, 16, 0x0041);

	/* set clock (PLL Config) */
	gsw_w32(cdev, 0xD100, 0, 16, 0x80);
	gsw_w32(cdev, 0xD101, 0, 16, 0x30);
	gsw_w32(cdev, 0xD102, 0, 16, 0x1100);
}
#endif
