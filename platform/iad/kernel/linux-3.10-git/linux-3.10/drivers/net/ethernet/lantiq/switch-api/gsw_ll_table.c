...
const ltq_lowlevel_fkts_t GSW_FLOW_fkt_tbl = {
	NULL, /* pNext */
	(u16) GSW_MAGIC, /* nType */
	158, /*125,*/ /*121*//* nNumFkts */
...
const ltq_lowlevel_fkts_t ltq_flow_fkt_tbl = {
...
const LTQ_ll_fkt gsw_rt_fkt_ptr_tbl[] = {
	/* 0x00 */
	(LTQ_ll_fkt) NULL,
...
const ltq_lowlevel_fkts_t ltq_rt_fkt_tbl = {
