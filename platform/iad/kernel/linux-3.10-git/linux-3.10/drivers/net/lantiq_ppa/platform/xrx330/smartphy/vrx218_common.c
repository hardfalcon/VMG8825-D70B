    ...
    if (func)
    {
        switch (type)
        {
            ...
            case LTQ_MEI_TC_REQUEST:
				g_ltq_mei_atm_showtime.req_tc_ptr = func;
				break;
            case LTQ_MEI_TC_RESET:
				g_ltq_mei_atm_showtime.tc_reset_ptr = func;
				break;
            case LTQ_MEI_ERB_ADDR_GET:
				g_ltq_mei_atm_showtime.erb_addr_ptr = func;
				break;
            default:
...
void *ppa_callback_get(e_ltq_mei_cb_type type)
{
	...
	case LTQ_MEI_TC_REQUEST:
            return g_ltq_mei_atm_showtime.req_tc_ptr;
	case LTQ_MEI_TC_RESET:
            return g_ltq_mei_atm_showtime.tc_reset_ptr;
        case LTQ_MEI_ERB_ADDR_GET:
			return g_ltq_mei_atm_showtime.erb_addr_ptr;
        default:
            err("mei unknown function type");
            return NULL;
    }
