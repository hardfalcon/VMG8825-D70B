...
extern void dp_exit(void);

extern struct proc_dir_entry *dp_proc_install(struct proc_dir_entry *);
extern void dp_proc_remove(void);
extern const char *dp_dbg_flag_str[];
extern unsigned int dp_dbg_flag_list[];
extern uint32_t dp_port_flag[];
extern const char *dp_port_type_str[];
extern const char *dp_port_status_str[];
extern const char *dp_subif_status_str[];
...
extern int dsl_chipset_type_get(void);
...
extern void dbg_pool_check(const char *str);
#endif				/*DATAPATH_H */
