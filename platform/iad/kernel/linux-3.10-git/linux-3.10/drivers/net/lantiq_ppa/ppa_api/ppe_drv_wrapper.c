...
int32_t (*ppa_sga_enable_hook)(uint32_t *f_enable, uint32_t flags) = NULL;
EXPORT_SYMBOL(ppa_sga_enable_hook);

int32_t (*ppa_sga_status_hook)(uint32_t *f_enable, uint32_t flags) = NULL;
EXPORT_SYMBOL(ppa_sga_status_hook);
#endif
