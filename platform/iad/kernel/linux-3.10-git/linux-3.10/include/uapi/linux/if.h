...
#define IFF_LTQ_ETH_FRAMEWORK 0x1000000	/* device created by ltq_eth_framework */
#define IFF_WANOE_DATAPATH 0x2000000	/* device used as WANoE datapath */
#define IFF_LAN_DATAPATH 0x4000000	/* device used as LAN datapath */
