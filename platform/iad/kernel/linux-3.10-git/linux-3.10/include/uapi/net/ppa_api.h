...
typedef enum {
	...
	PPA_CMD_GET_MAC_ENTRY_NR,      /*!< NR for PPA_CMD_GET_MAC_ENTRY */
...
/**  PPA Get a MAC entry to the bridging MAC table Command. Value is manipulated by _IOW() macro for final value
  \param PPA_CMD_MAC_ENTRY The parameter points to a
  \ref PPA_CMD_MAC_ENTRY structure
*/
#define PPA_CMD_GET_MAC_ENTRY                   _IOW(PPA_IOC_MAGIC,  PPA_CMD_GET_MAC_ENTRY_NR,  PPA_CMD_MAC_ENTRY)
