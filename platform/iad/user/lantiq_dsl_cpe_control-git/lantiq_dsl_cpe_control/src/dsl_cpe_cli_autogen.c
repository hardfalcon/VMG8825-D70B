   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.nCommand);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d %d %d %d", &pData.nDirection, &pData.data.bTrellisEnable, &pData.data.bBitswapEnable, &pData.data.bReTxEnable, &pData.data.bVirtualNoiseSupport);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d", &pData.nChannel, &pData.nDirection);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d", &pData.data.nDbgModule, &pData.data.nDbgLevel);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.nDbgModule);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.nTestMode);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %x %x %d", &pData.data.nTcLayer, &pData.data.nEfmTcConfigUs, &pData.data.nEfmTcConfigDs, &pData.data.nSystemIf);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d", &pData.data.nEventType, &pData.data.bMask);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.nEventType);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.nStatusSelector);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d", &pData.data.nConfigSelector, &pData.data.nConfigValue);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d %d", &pData.data.nLDSF, &pData.data.nACSF, &pData.data.nStartupMode);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d %u %u", &pData.nChannel, &pData.nDirection, &pData.data.nDataRateThresholdUpshift, &pData.data.nDataRateThresholdDownshift);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d", &pData.nDirection, &pData.nDeltDataType);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.nPowerManagementState);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d", &pData.nDirection, &pData.data.nLineFailures);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d %x", &pData.nChannel, &pData.nDirection, &pData.data.nDataPathFailures);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d", &pData.nDirection, &pData.data.RA_MODE);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %u", &pData.nDirection, &pData.nHistoryInterval);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %u %u %u %u %u", &pData.nDirection, &pData.data.nES, &pData.data.nSES, &pData.data.nLOSS, &pData.data.nUAS, &pData.data.nLOFS);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%u %u %u %u", &pData.data.nFullInits, &pData.data.nFailedFullInits, &pData.data.nShortInits, &pData.data.nFailedShortInits);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d %u", &pData.nChannel, &pData.nDirection, &pData.nHistoryInterval);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d %u %u", &pData.nChannel, &pData.nDirection, &pData.data.nCodeViolations, &pData.data.nFEC);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%hhu %d %u %u %u %u %u %u %u %u %u %u", &pData.nChannel, &pData.nDirection, &pData.data.nHEC, &pData.data.nTotalCells, &pData.data.nUserTotalCells, &pData.data.nIBE, &pData.data.nCRC_P, &pData.data.nCRCP_P, &pData.data.nCV_P, &pData.data.nCVP_P, &pData.data.nTxUserTotalCells, &pData.data.nTxIBE);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.bOneDayElapsed);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d", &pData.data.nMode);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %u %u %u", &pData.data.bActivate, &pData.data.nMode.nPmTick, &pData.data.nMode.nPm15Min, &pData.data.nMode.nPm15MinPerDay);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %d %hhu %hhu %hhu", &pData.data.bNePollingOff, &pData.data.bFePollingOff, &pData.data.nBasicUpdateCycle, &pData.data.nFeUpdateCycleFactor, &pData.data.nFeUpdateCycleFactorL2);
   ...
   DSL_CPE_File_t *out)
{
   ...
   sscanf (pCommands, "%d %u %u %u %u", &pData.nDirection, &pData.data.nRxCorruptedTotal, &pData.data.nRxUncorrectedProtected, &pData.data.nRxRetransmitted, &pData.data.nRxCorrected);
