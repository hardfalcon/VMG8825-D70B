...
/* ulrv 27.04.2006 */
void relayNoReplaceGotSessionPacket(PPPoEInterface const *i);
/* ulrv ************/
...
/* ulrv 27.04.2006 */
void relayNoReplaceHandlePADT(PPPoEInterface const *iface, PPPoEPacket *packet, int size);
void relayNoReplaceHandlePADS(PPPoEInterface const *iface, PPPoEPacket *packet, int size);
void relayNoReplaceHandlePADO(PPPoEInterface const *iface, PPPoEPacket *packet, int size);
/* ulrv ************/
