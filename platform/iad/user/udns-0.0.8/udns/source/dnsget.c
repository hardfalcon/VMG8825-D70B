/* $Id: dnsget.c,v 1.1.3.0 2006-06-19 10:18:02+02 titzec Exp $
...
int main(int argc, char **argv) {
  ...
  if (dns_init(0,interf,resolv) < 0 || !(nctx = dns_new(NULL,resolv)))
...
"Usage: %s interface resolv_file [options] domain-name...\n"
"where options are:\n"
...
"  (may be specified more than once)\n"
  ...
  for (i = 0; i < argc; ++i) {
    ...
    if (!dns_submit_p(NULL, name, qcls, l_qtyp, abs, 0, dnscb, q))
