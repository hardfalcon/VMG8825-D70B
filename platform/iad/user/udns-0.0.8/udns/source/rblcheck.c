/* $Id: rblcheck.c,v 1.1.3.0 2006-06-19 10:18:06+02 titzec Exp $
...
int main(int argc, char **argv) {
  ...
  while((c = getopt(argc-2, &argv[2], "hqtvms:S:cn:")) != EOF) switch(c) {
  ...
  case 'h':
    printf("%s: %s.\n", progname, version);
    printf("Usage is: %s interface resolv_file [options] address..\n", progname);
    printf(
"Where options are:\n"
